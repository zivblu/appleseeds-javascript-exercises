(function Hangman () {
    ...
    let words = ["florence", "paris", "madrid", "rome", "singapore", "dubai", "new york city", 
    ...
    function checkLetters(letter) {
        ...
        if (numLettersOfWord.toString() == blanksAndCorrect.toString()) {
            figlet('        Congratulations You Won!! '+ '\n' 
            + '               You got ' 
            ...
            function(err, data) {
                ...
                console.log('\n' + '\n' + 'You are out of guesses, The word was ' + chalk.red(randomiseWord) + '\n' + '\n');
                console.log(chalk.red.dim.bold(data));
            });
        }else{
